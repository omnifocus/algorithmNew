 ...
 */
public class Code01_MergeKSortedList_1 {

    public static void main(String[] args) {
        ListNode[] listNodes = new ListNode[3];
        PriorityQueue<ListNode> q = new PriorityQueue(new Comparator() {
            @Override
...
//        listNodes[2].next = new ListNode(6);
        ...
        ListNode listNode = new Code01_MergeKSortedList_1().mergeKLists(listNodes);
