 ...
 */
public class Code08_MergeTwoSortedLinkedList_1 {
    ...
    private static ListNode mergeTwoLinks(ListNode head1, ListNode head2) {
        ...
        ListNode ansNode = head1.val < head2.val ? head1 : head2;
        ListNode nextNode = ansNode;
        if (ansNode == head1) {
            head1 = head1.next;
        } else {
            head2 = head2.next;
        ...
        nextNode.next = head1 == null ? head2 : head1;
